  ...
  setup() {
      ...
      () => {
        if (this.state.isInitaited) {
          ...
          const data = {
            ...
            selectedFilters: this.state.selectedTemplate || 'new-arrival',
          };
    ...
    onWillStart(async () => {
      ...
      if (this?.props?.colValue?.data?.template) {
        ...
        this.state.allProducts = this?.props?.colValue?.data?.allProducts || false;
        this.state.selectedFilters = this?.props?.colValue?.data?.selectedFilters || 'new-arrival';
      }
