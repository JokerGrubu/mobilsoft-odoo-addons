...
{ 
    ...
    'depends': [
        'web','crest_theme_core','website_sale','html_builder','html_editor','odoo_gpt_chat'
    ],
    'data': [
    ...
    'assets': {
        ...
        'web.assets_frontend': [
            ...
            'theme_crest/static/src/public_read/interactions.js',
        ...
        'website.website_builder_assets': [
            'theme_crest/static/src/lib/jquery-3.7.1.slim.min.js',
            'theme_crest/static/src/lib/OwlCarousel-2.3.4/assets/owl.carousel.min.css',
            'theme_crest/static/src/lib/OwlCarousel-2.3.4/assets/owl.theme.default.css',
            'theme_crest/static/src/scss/dynamic_snippets/dynamic_snippets_template.scss',
            'theme_crest/static/src/lib/OwlCarousel-2.3.4/owl.carousel.js', 
            ...
            'theme_crest/static/src/snippets/snippet_service.js',
            # 'theme_crest/static/src/builder/*',
            # 'theme_crest/static/src/js/snippet.option.js',
            'theme_crest/static/src/builder/theme_customise_option.xml',
            'theme_crest/static/src/builder/dynamic_snippets.xml',
            'theme_crest/static/src/builder/dynamic_snippets.js',
            'theme_crest/static/src/js/static_template/config_carousel.js',
        ...
        'html_builder.assets': [
            'theme_crest/static/src/snippets/block_tab.xml',
        ],   
        'html_editor.assets_editor': [
           'theme_crest/static/src/editor.js',
        ],
    },
    # Author
    'author': 'Terabits Technolab',
    'website': 'https://www.terabits.xyz/apps/19.0/theme_crest',
    ...
    "price": "00.0",
    'currency': 'USD',
    'live_test_url': 'https://www.terabits.xyz/request_demo?source=index&version=19&app=theme_crest',
}
