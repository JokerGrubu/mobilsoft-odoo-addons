...
from odoo.addons.mobilsoft_chart_update.tests.common import TestAccountChartUpdateCommon
...
class TestAccountChartUpdate(TestAccountChartUpdateCommon):
    ...
    def test_01_chart_update(self):
        ...
        name = field.with_context(mobilsoft_chart_update=True).display_name
