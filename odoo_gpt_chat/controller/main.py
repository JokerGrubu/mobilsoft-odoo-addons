...
class whisperchat(http.Controller):
    ...
    @http.route('/get/chatbot', type="jsonrpc", auth="public")
    ...
    @http.route('/get/login/user', type='jsonrpc', auth='public', cors="*")
    ...
    @http.route('/create/chatbot/lead', type="jsonrpc", auth="none", cors="*")
